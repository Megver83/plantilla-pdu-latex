...
% Estilo de secciones sin numerar
\titleformat{\section}[block]
  {\normalfont\Huge\color{UoDBlue}}  % Muy grande, sin negrita, color azul
  {}
  {0pt}
  {}
...
\newcommand{\sectionline}{%
  \par\noindent
  \tikz{\draw[UoDBlue, line width=0.8pt, dash pattern=on 3pt off 2pt] (0,0)--(\linewidth,0);}%
  \par
}
...
\newcommand{\FilaSubIndicador}[5]{%
  ...
  \multicolumn{1}{!{\color{gray!40}\vrule width 10pt}>{\hspace{0.01mm}}l!{\color{black!90}\vrule width 0.5pt}}{#1}
  % Segunda columna
  & #2
  % Tercera columna
  &
...
\begin{tikzpicture}
  ...
  \ifnum\catNum=1 \def\categoria{MEDIO} \def\colorCategoria{yellow!80!black}\fi
  \ifnum\catNum=2 \def\categoria{ÓPTIMO} \def\colorCategoria{green!50!black}\fi
